...
export class AppointmentComponent implements OnInit {
  ...
  refreshAppointments(): void {
    ...
    this.appointmentService.getBySearchParamsEmployee(params);
  }
  ...
  effectuer(appt: any){
    ...
    this.appointmentService.update(appt._id, { "status": true })
      .subscribe({
        next: (response: any) =>  {     
        ...
        complete: () => console.info("effectuer completed succesfully")
      })   
